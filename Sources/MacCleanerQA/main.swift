...
let fixtureRoot = URL(fileURLWithPath: "/Users/federicotrevisani/MacCleaner/QA/MacCleanerFixture", isDirectory: true)
...
guard result.unusedApps.contains(where: { $0.record.bundleIdentifier == "com.federicotrevisani.MacCleanerFixture.OldFixtureApp" }) else {
